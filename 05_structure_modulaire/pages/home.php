    ...
    <div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel" data-bs-touch="true">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                <img src="./assets/images/ocean-3605547_1280.jpg" class="d-block w-100" alt="Ocean">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="./assets/images/mountains-190055_1280.jpg" class="d-block w-100" alt="Mountains">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="./assets/images/beach-1852945_1280.jpg" class="d-block w-100" alt="Beach">
                <div class="carousel-caption d-none d-md-block">
